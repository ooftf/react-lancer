        ...
        return (
            <ViewPagerAndroid
                ...
                <View style={styles.fillView}>
                    <ImageBackground style={styles.fillView} source={require("../image/guide_first.png")}>
                        <TouchableOpacity
                ...
                <View style={styles.fillView}>
                    <ImageBackground style={styles.fillView} source={require("../image/guide_second.png")}>
                        <TouchableOpacity
                            onPress={()=>{
                ...
                <View style={styles.fillView}>
                    <ImageBackground style={styles.third} source={require("../image/guide_third.png")}>
                        <TouchableOpacity
